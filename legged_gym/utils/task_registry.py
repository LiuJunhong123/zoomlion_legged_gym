...
from rsl_rl.runners import OnPolicyRunner, OnPolicyRunnerAmp
...
class TaskRegistry():
    ...
    def make_alg_runner(self, env, name=None, args=None, train_cfg=None, log_root="default") -> Tuple[Union[OnPolicyRunner, OnPolicyRunnerAmp], LeggedRobotCfgPPO]:
